...
/*!*************************************************!*\
  !*** ./src/app/services/affectation.service.ts ***!
  \*************************************************/
/*! exports provided: AffectationService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AffectationService", function() { return AffectationService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
var AffectationService = /** @class */ (function () {
    function AffectationService(db) {
        this.affectationsCollection = db.collection('affectations');
        this.affectations = this.affectationsCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (actions) {
    ...
    AffectationService.prototype.getAffectations = function () {
        return this.affectations;
    };
    AffectationService.prototype.getAffectationsHours = function () {
        //return this.affectations.utilisateur;
    };
    AffectationService.prototype.getAffectation = function (id) {
        return this.affectationsCollection.doc(id).valueChanges();
    };
    AffectationService.prototype.updateAffectation = function (affectation, id) {
        return this.affectationsCollection.doc(id).update(affectation);
    };
    AffectationService.prototype.addAffectation = function (affectation) {
        return this.affectationsCollection.add(affectation);
    };
    AffectationService.prototype.removeAffectation = function (id) {
        return this.affectationsCollection.doc(id).delete();
    };
    AffectationService.ctorParameters = function () { return [
        { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_1__["AngularFirestore"] }
    ]; };
    AffectationService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/***/ "./src/app/services/ordinateur.service.ts":
/*!************************************************!*\
  !*** ./src/app/services/ordinateur.service.ts ***!
  \************************************************/
/*! exports provided: OrdinateurService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OrdinateurService", function() { return OrdinateurService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/fire/firestore */ "./node_modules/@angular/fire/firestore/index.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
...
var OrdinateurService = /** @class */ (function () {
    function OrdinateurService(db) {
        this.ordinateursCollection = db.collection('ordinateurs');
        this.ordinateurs = this.ordinateursCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (actions) {
            return actions.map(function (a) {
                var data = a.payload.doc.data();
                var id = a.payload.doc.id;
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ id: id }, data);
    ...
    OrdinateurService.prototype.getOrdinateurs = function () {
        return this.ordinateurs;
    };
    OrdinateurService.prototype.getOrdinateur = function (id) {
        return this.ordinateursCollection.doc(id).valueChanges();
    };
    OrdinateurService.prototype.updateOrdinateur = function (ordinateur, id) {
        return this.ordinateursCollection.doc(id).update(ordinateur);
    };
    OrdinateurService.prototype.addOrdinateur = function (ordinateur) {
        return this.ordinateursCollection.add(ordinateur);
    };
    OrdinateurService.prototype.removeOrdinateur = function (id) {
        return this.ordinateursCollection.doc(id).delete();
    };
    OrdinateurService.ctorParameters = function () { return [
        { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_1__["AngularFirestore"] }
    ]; };
    OrdinateurService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_1__["AngularFirestore"]])
...
var UtilisateurService = /** @class */ (function () {
    function UtilisateurService(db) {
        this.utilisateursCollection = db.collection('utilisateurs');
        this.utilisateurs = this.utilisateursCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (actions) {
            return actions.map(function (a) {
                var data = a.payload.doc.data();
                var id = a.payload.doc.id;
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ id: id }, data);
    ...
    UtilisateurService.prototype.getUtilisateur = function (id) {
        return this.utilisateursCollection.doc(id).valueChanges();
    };
    UtilisateurService.prototype.updateUtilisateur = function (utilisateur, id) {
        return this.utilisateursCollection.doc(id).update(utilisateur);
    };
    UtilisateurService.prototype.addUtilisateur = function (utilisateur) {
        return this.utilisateursCollection.add(utilisateur);
    };
    UtilisateurService.prototype.removeUtilisateur = function (id) {
