...
let AffectationService = class AffectationService {
    constructor(db) {
        this.affectationsCollection = db.collection('affectations');
        this.affectations = this.affectationsCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => {
    ...
    updateAffectation(affectation, id) {
...
AffectationService.ctorParameters = () => [
...
let OrdinateurService = class OrdinateurService {
    constructor(db) {
        this.ordinateursCollection = db.collection('ordinateurs');
        this.ordinateurs = this.ordinateursCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => {
            return actions.map(a => {
                const data = a.payload.doc.data();
                const id = a.payload.doc.id;
                return Object.assign({ id }, data);
...
OrdinateurService.ctorParameters = () => [
    { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_1__["AngularFirestore"] }
];
...
let UtilisateurService = class UtilisateurService {
    constructor(db) {
        ...
        this.utilisateurs = this.utilisateursCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => {
            return actions.map(a => {
                const data = a.payload.doc.data();
                const id = a.payload.doc.id;
                return Object.assign({ id }, data);
    ...
    updateUtilisateur(utilisateur, id) {
